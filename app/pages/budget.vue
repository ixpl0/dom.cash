<template>
  <NuxtLayout>
    ...
    <SharedBudgetsModal
      ref="sharedBudgetsModal"
      :initial-budgets="sharedBudgets"
    />
  </NuxtLayout>
</template>
...
const sharedBudgetsModal = ref<InstanceType<typeof SharedBudgetsModal> | null>(null)
const sharedBudgets = ref([{ id: '1', username: 'friend' }]) // TODO: загрузить данные с бекенда
