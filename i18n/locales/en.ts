...
export default {
  ...
  budget: {
    ...
    planningModeTooltip: 'Toggle planning mode: enter expected balance change for upcoming months and compare planned vs actual for past months',
    export: 'Export',
    ...
    month: {
      ...
      addPlan: 'Set plan',
      plannedTooltip: 'Planned balance change. Click to set or update.',
      plannedReadOnlyTooltip: 'Planned balance change (read-only).',
      plannedPastTooltip: 'Planned balance change. Past month — plan editing is not available.',
      plannedVsActualTooltip: 'Top — plan, bottom — deviation of actual from plan for the past month.',
      expectedBalanceTooltip: 'Expected end-of-month balance based on the plan. Chained forward from the latest actual balance.',
      expectedBalancePastTooltip: 'Actual end-of-month balance for the past month.',
    },
    ...
    year: {
      ...
      plannedLine1: 'Planned',
      plannedLine2: 'change',
      plannedFormula: 'Planned balance change and comparison with actual for past months',
      totalPlanned: 'Planned balance change for the year',
      totalPlannedDiff: 'Deviation of actual from plan for past months',
      expectedBalanceLine1: 'Expected',
  ...
  notifications: {
    ...
    budget_plan_updated: '{username} updated the plan for {month} {year}',
    ...
    todo_created: '{username} shared a task with you: "{todoContent}"',
    todo_updated: '{username} updated task: "{todoContent}"',
    todo_deleted: '{username} deleted task: "{todoContent}"',
    todo_toggled: '{username} marked "{todoContent}" as {isCompleted}',
  },
  ...
  todo: {
    ...
    recurrence: {
      ...
      dayOfMonth: 'Every N day of month',
      units: {
        day: 'days',
        week: 'weeks',
        month: 'months',
