...
export default {
  ...
  serverErrors: {
    ...
    memo_not_found: 'Запись не найдена',
    memo_id_required: 'Требуется ID записи',
    memo_not_todo: 'Эта запись не является задачей',
  },
  ...
  memo: {
    ...
    emptyTodo: 'Пока нет задач',
    emptyMemo: 'Пока нет заметок',
    emptyPlan: 'Пока нет планов',
    types: {
      todo: 'Без напоминания',
      memo: 'Заметка',
      plan: 'С напоминанием',
    },
    modal: {
      ...
      typeLabel: 'Тип',
      contentLabel: 'Текст напоминания',
      contentPlaceholder: 'Введите текст...',
      dateLabel: 'Дата и время напоминания',
      shareLabel: 'Поделиться с',
      sharePrivate: 'Никто не выбран (Личная запись)',
      cancel: 'Отмена',
      save: 'Сохранить',
    },
    card: {
    ...
    delete: {
      ...
      message: 'Эта запись будет удалена безвозвратно.',
      confirm: 'Удалить',
    },
    errors: {
      ...
      contentRequired: 'Введите содержание',
      dateRequired: 'Выберите дату для плана',
    },
    toast: {
      ...
      uncompleted: 'Задача отмечена как невыполненная',
    },
  },
